...
contract MerkleTreeAccumulatorLibTest is Test {
  ...
  function eq(bytes32[] memory arr1, bytes32[] memory arr2) internal pure {
    require(
      keccak256(abi.encode(arr1)) == keccak256(abi.encode(arr2)),
      'Arrays not equal'
    );
  }
  ...
  function expansionsFromLeaves(
    ...
    for (uint256 i = 0; i < leaves.length; i++) {
      if (i < lowSize) {
        lowExpansion = MerkleTreeAccumulatorLib.appendLeaf(
          lowExpansion,
          leaves[i]
        );
      } else {
      ...
      highExpansion = MerkleTreeAccumulatorLib.appendLeaf(
        highExpansion,
        leaves[i]
      );
    }
  ...
  function testRootTooLarge() public {
    bytes32[] memory expansion = new bytes32[](
      MerkleTreeAccumulatorLib.MAX_LEVEL + 1
    );
  ...
  function testAppendCS(uint256 treeSize) public {
    ...
    for (uint256 i = 0; i < expansion.length; i++) {
      ...
      bytes32[] memory post = MerkleTreeAccumulatorLib.appendCompleteSubTree(
        expansion,
        i,
        rand
      );
  ...
  function testAppendCsLevelTooHigh() public {
    ...
    MerkleTreeAccumulatorLib.appendCompleteSubTree(
      pre,
      MerkleTreeAccumulatorLib.MAX_LEVEL,
      rand
    );
  }

  function testAppendCsMeTooLargs() public {
    bytes32[] memory pre = new bytes32[](
      MerkleTreeAccumulatorLib.MAX_LEVEL + 1
    );
  ...
  function testAppendLeafOne() public {
    ...
    assertEq(
      post[1],
      hashTogether(slot0, keccak256(abi.encodePacked(leaf))),
      'Post slot 1'
    );
  }
  ...
  function testMaximumAppendBetween() public {
    assertEq(
      MerkleTreeAccumulatorLib.maximumAppendBetween(0, 1),
      0,
      'Max append 0,1'
    );

    assertEq(
      MerkleTreeAccumulatorLib.maximumAppendBetween(0, 2),
      1,
      'Max append 0,2'
    );
    assertEq(
      MerkleTreeAccumulatorLib.maximumAppendBetween(1, 2),
      0,
      'Max append 1,2'
    );

    assertEq(
      MerkleTreeAccumulatorLib.maximumAppendBetween(0, 3),
      1,
      'Max append 0,3'
    );
    assertEq(
      MerkleTreeAccumulatorLib.maximumAppendBetween(1, 3),
      0,
      'Max append 1,3'
    );
    assertEq(
      MerkleTreeAccumulatorLib.maximumAppendBetween(2, 3),
      0,
      'Max append 2,3'
    );

    assertEq(
      MerkleTreeAccumulatorLib.maximumAppendBetween(0, 4),
      2,
      'Max append 0,4'
    );
    assertEq(
      MerkleTreeAccumulatorLib.maximumAppendBetween(1, 4),
      0,
      'Max append 1,4'
    );
    assertEq(
      MerkleTreeAccumulatorLib.maximumAppendBetween(2, 4),
      1,
      'Max append 2,4'
    );
    assertEq(
      MerkleTreeAccumulatorLib.maximumAppendBetween(3, 4),
      0,
      'Max append 3,4'
    );

    assertEq(
      MerkleTreeAccumulatorLib.maximumAppendBetween(0, 5),
      2,
      'Max append 0,5'
    );
    assertEq(
      MerkleTreeAccumulatorLib.maximumAppendBetween(1, 5),
      0,
      'Max append 1,5'
    );
    assertEq(
      MerkleTreeAccumulatorLib.maximumAppendBetween(2, 5),
      1,
      'Max append 2,5'
    );
    assertEq(
      MerkleTreeAccumulatorLib.maximumAppendBetween(3, 5),
      0,
      'Max append 3,5'
    );
    assertEq(
      MerkleTreeAccumulatorLib.maximumAppendBetween(4, 5),
      0,
      'Max append 4,5'
    );

    assertEq(
      MerkleTreeAccumulatorLib.maximumAppendBetween(0, 6),
      2,
      'Max append 0,6'
    );
    assertEq(
      MerkleTreeAccumulatorLib.maximumAppendBetween(1, 6),
      0,
      'Max append 1,6'
    );
    assertEq(
      MerkleTreeAccumulatorLib.maximumAppendBetween(2, 6),
      1,
      'Max append 2,6'
    );
    assertEq(
      MerkleTreeAccumulatorLib.maximumAppendBetween(3, 6),
      0,
      'Max append 3,6'
    );
    assertEq(
      MerkleTreeAccumulatorLib.maximumAppendBetween(4, 6),
      1,
      'Max append 4,6'
    );
    assertEq(
      MerkleTreeAccumulatorLib.maximumAppendBetween(5, 6),
      0,
      'Max append 5,6'
    );

    assertEq(
      MerkleTreeAccumulatorLib.maximumAppendBetween(0, 7),
      2,
      'Max append 0,7'
    );
    assertEq(
      MerkleTreeAccumulatorLib.maximumAppendBetween(1, 7),
      0,
      'Max append 1,7'
    );
    assertEq(
      MerkleTreeAccumulatorLib.maximumAppendBetween(2, 7),
      1,
      'Max append 2,7'
    );
    assertEq(
      MerkleTreeAccumulatorLib.maximumAppendBetween(3, 7),
      0,
      'Max append 3,7'
    );
    assertEq(
      MerkleTreeAccumulatorLib.maximumAppendBetween(4, 7),
      1,
      'Max append 4,7'
    );
    assertEq(
      MerkleTreeAccumulatorLib.maximumAppendBetween(5, 7),
      0,
      'Max append 5,7'
    );
    assertEq(
      MerkleTreeAccumulatorLib.maximumAppendBetween(6, 7),
      0,
      'Max append 6,7'
    );

    assertEq(
      MerkleTreeAccumulatorLib.maximumAppendBetween(0, 8),
      3,
      'Max append 0,8'
    );
    assertEq(
      MerkleTreeAccumulatorLib.maximumAppendBetween(1, 8),
      0,
      'Max append 1,8'
    );
    assertEq(
      MerkleTreeAccumulatorLib.maximumAppendBetween(2, 8),
      1,
      'Max append 2,8'
    );
    assertEq(
      MerkleTreeAccumulatorLib.maximumAppendBetween(3, 8),
      0,
      'Max append 3,8'
    );
    assertEq(
      MerkleTreeAccumulatorLib.maximumAppendBetween(4, 8),
      2,
      'Max append 4,8'
    );
    assertEq(
      MerkleTreeAccumulatorLib.maximumAppendBetween(5, 8),
      0,
      'Max append 5,8'
    );
    assertEq(
      MerkleTreeAccumulatorLib.maximumAppendBetween(6, 8),
      1,
      'Max append 6,8'
    );
    assertEq(
      MerkleTreeAccumulatorLib.maximumAppendBetween(7, 8),
      0,
      'Max append 7,8'
    );

    assertEq(
      MerkleTreeAccumulatorLib.maximumAppendBetween(0, 9),
      3,
      'Max append 0,9'
    );
    assertEq(
      MerkleTreeAccumulatorLib.maximumAppendBetween(1, 9),
      0,
      'Max append 1,9'
    );
    assertEq(
      MerkleTreeAccumulatorLib.maximumAppendBetween(2, 9),
      1,
      'Max append 2,9'
    );
    assertEq(
      MerkleTreeAccumulatorLib.maximumAppendBetween(3, 9),
      0,
      'Max append 3,9'
    );
    assertEq(
      MerkleTreeAccumulatorLib.maximumAppendBetween(4, 9),
      2,
      'Max append 4,9'
    );
    assertEq(
      MerkleTreeAccumulatorLib.maximumAppendBetween(5, 9),
      0,
      'Max append 5,9'
    );
    assertEq(
      MerkleTreeAccumulatorLib.maximumAppendBetween(6, 9),
      1,
      'Max append 6,9'
    );
    assertEq(
      MerkleTreeAccumulatorLib.maximumAppendBetween(7, 9),
      0,
      'Max append 7,9'
    );
    assertEq(
      MerkleTreeAccumulatorLib.maximumAppendBetween(8, 9),
      0,
      'Max append 8,9'
    );
  }
  ...
  function testVerifyInclusionProofManual() public {
    ...
    proof[2] = hashTogether(
      hashTogether(re[0], re[1]),
      hashTogether(re[2], re[3])
    );
    ...
    MerkleTreeAccumulatorLib.verifyInclusionProof(
      MerkleTreeAccumulatorLib.root(me),
      leaves[index],
      index,
      proof
    );
  ...
  function verifyInclusion(uint256 index, uint256 treeSize) internal {
    ...
    bytes32[] memory re = ProofUtils.rehashed(leaves);
    bytes32[] memory me = ProofUtils.expansionFromLeaves(
      leaves,
      0,
      leaves.length
    );
  ...
  function testEmptyTreeSize() public {
    bytes32[] memory me = new bytes32[](0);
    assertEq(
      MerkleTreeAccumulatorLib.treeSize(me),
      0,
